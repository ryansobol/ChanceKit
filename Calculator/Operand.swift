  ...
  func value() throws -> Int {
    ...
    case let .roll(times, sides):
      ...
      for _ in 1...abs(times) {
        // Each die is an independent source of random numbers—that is, the sequence of numbers
        // generated by one instance of GKRandomDistribution has no effect on the sequence generated
        // by another instance
